...
import land.tbp.year2021.`2021 - Day 23 - Amphipod`.Companion.solve231
import measureTimeAndPrint
import readInput
import java.util.Vector

private class `2021 - Day 23 - Amphipod` {
    companion object {

        private fun calculateCost(fish: Fish23, steps: Int): Int =
            when (fish) {
                A -> steps * 1
                B -> steps * 10
                C -> steps * 100
        ...
        private fun dbg23(home: List<Location23>) {
    ...
    """.trimIndent().replace("#", " "))
        ...
        private fun pathCost(from: Location23, to: Location23, home: List<Location23>, steps: Int = 0, visited: List<Int> = listOf(from.id)): Int {
...
private enum class Fish23 { A, B, C, D }

private data class Location23(
    val id: Int,
...
private fun `2021 - Day 23 - Amphipod - Part 1`(input: List<String>): Int {
    val home = listOf(
        // part 2
        ...
        Location23(10, listOf(9, 11), true),
...
fun main() {
    ...
    measureTimeAndPrint {
        println(`2021 - Day 23 - Amphipod - Part 1`(inputTest))
//    println(`2021 - Day 23 - Amphipod - Part 1`(input))

//    println(`2021 - Day 23 - Amphipod - Part 2`(inputTest))
//    println(`2021 - Day 23 - Amphipod - Part 2`(input))
    }
}
