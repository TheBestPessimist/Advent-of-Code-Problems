...
import land.tbp.year2019.day_9_sensor_boost.solve1
import land.tbp.year2019.day_9_sensor_boost.solve2
...
internal class ComputerTest {
    ...
    internal inner class Day2 {
        ...
        @Test
        fun `Day-2_1`() {
            val text = loadResourceFile("./land/tbp/year2019/day_2_1202_program_alarm/in1.txt")
    ...
    internal inner class Day5 {
        ...
        @Test
        fun `Day 5 Problem 1`() {
            val text = loadResourceFile("./land/tbp/year2019/day_5_sunny_with_a_chance_of_asteroids/in1.txt")
            val ints = stringToInt(text)
